...
pulse_input input1 = {19, false};  //Setting GPIO Pin 19 to record the pulses
...
void setup() {
  ...
  servo1.attach(18, 500, 2400);  //Attaching the servo at pin 18 and setting the maximum and minimum PWM values
	pinMode(input1.PIN, INPUT_PULLDOWN);  //pin 19 set as Pulldown input to read the pulse
	pinMode(14,OUTPUT);  //setting pin 14 as LED output
